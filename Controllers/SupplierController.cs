    ...
    public class SupplierController : ApiController
    {
            ...
            string query = @"
                    select SupplierId,
                           ...
                           FullName,
                            ...
                            from
	                        dbo.Supplier Sup
	                  inner join dbo.SupplierCategory SupCat on  Sup.SupplierCategoryId=SupCat.SupplierCategoryId 
        ...
        public string Post(Supplier supplier)
        {
            try
            {
                ...
                {
                    string query = @"
                       insert into dbo.Supplier(FullName,AFM,Address,Email,Phone,Active,SupplierCategoryId) values
                      (
                       '" + supplier.FullName + @"'
                       ,'" + supplier.AFM + @"'
                       ,'" + supplier.Address + @"'
